...
const Recruitment3 = () => {
  ...
  return (
    <div className="w-full bg-navy-500 font-sans text-white selection:bg-cyan-400/30">
      {/* HERO */}
      ...
      <div className="py-16 text-lg">
        ...
        <div className="w-full">
          {/* BANNER TOP */}
          <div className="relative mx-auto mb-10 h-[450px] w-full max-w-7xl overflow-hidden rounded-lg px-6">
            <img
              src="/assets/business-meeting-saudi-arabia-1024x683.webp"
          ...
          <section className="container mx-auto max-w-7xl px-6 pb-16">
            <h2 className="mb-6 text-3xl font-bold">About Our Recruitment Solutions</h2>
          ...
          <section
            id="executive"
            className="relative rounded-xl bg-cover bg-center py-28"
          ...
          <section
            id="rpo"
            className="relative rounded-xl bg-cover bg-center px-6 py-28"
        ...
        <section className="mx-auto mt-20 max-w-7xl px-6">
          <h2 className="mb-8 text-3xl font-bold text-white md:text-4xl">View More Services</h2>
